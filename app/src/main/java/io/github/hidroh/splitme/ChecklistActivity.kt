...
class ChecklistActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.enableServiceButton.setOnClickListener { _: View? -> startActivity(Intent(Settings.ACTION_ACCESSIBILITY_SETTINGS)) }
        binding.disableOptimizationsButton.setOnClickListener { _: View? -> startActivity(Intent(Settings.ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS, Uri.parse("package:$packageName"))) }
